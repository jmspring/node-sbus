...
function EventHubInstance(ns, name, user, pass) {
  var instance = {
   ...
   function get_partition(group, id, messenger, subscribed) {
        return eventhub_partition.Instance(instance, group, id, messenger, subscribed);
      }
    ...
    getRandomPartition: function(group, callback) {
      function randomPartition(group) {
        ...
        var partition = eventhub_partition.Instance(instance, group, keys[i], null, false);
        return partition;
      }
    ...
    getEventProcessor: function(group, callback) {
      ...
      function get_event_processor(group) {
        return eventhub_processor.Instance(instance, group);
      }
